...
push(@curlopts, '--verbose') if ($debug); # curl acts verbosely
...
create-object    PASSARGS  create  /api/object.xml            a=b       c=d  ...
...
update-data      SUB1PASS  update  /api/object/OID            42        a=b  c=d  ...
